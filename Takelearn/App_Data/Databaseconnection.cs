...
public class DatabaseConnection
{
    ...
    //private static string databaseName = "janam";
    //private static string databasePath = System.AppDomain.CurrentDomain.BaseDirectory + "App_Data\\" + databaseName;
    //private static string connectionString = "Data Source=DESKTOP-76LP5HK;AttachDbFilename=" + databasePath + ";Integrated Security=True";

    private static string connectionString = "Data Source=DESKTOP-76LP5HK\\SQLEXPRESS01;Initial Catalog=Takelearn;Integrated Security=True"
          ;
