<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManageTutor.aspx.cs" Inherits="Takelearn.home.ManageTutor" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Manage Tutor | Takelearn</title>
    <meta charset="utf-8" />
            ...
            <Columns>
               ...
               <asp:TemplateField HeaderText="User ID" Visible="false" ItemStyle-Width="150">
                ...
                <asp:TemplateField HeaderText="Registered Date" ItemStyle-Width="150">
                    <ItemTemplate>
                        <asp:Label ID="lblrole" runat="server" Text='<%# Eval("created_date") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
...
<script type="text/javascript">
    ...
    <legend style="font-size:18px;">Add Tutor </legend>
        ...
        <asp:TextBox ID="TextBox3" runat="server" TextMode="Password"></asp:TextBox>
                ...
                <label for="number"><b>Number <span style="color: red;">*</span></b><asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ForeColor="Red" ErrorMessage="Number is mandatory." ControlToValidate="Number" ValidationGroup="signupbtn"></asp:RequiredFieldValidator><asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="Number" ForeColor="Red" ValidationGroup="signupbtn" ErrorMessage="Number should be of 10 digits." ValidationExpression="[0-9]{10}"></asp:RegularExpressionValidator></label>
                ...
                <label for="gender"><b>Gender <span style="color: red;">*</span></b><asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ForeColor="Red" ErrorMessage="Please select Gender" ControlToValidate="DropDownList3" ValidationGroup="signupbtn"></asp:RequiredFieldValidator></label>
                <asp:RadioButtonList ID="DropDownList3" CssClass="inputtext" runat="server">
        ...
        <asp:TextBox ID="TextBox4" runat="server"></asp:TextBox>
                ...
                <asp:Button runat="server" ID="btn_Signup" CssClass="lgnbtn" Text="Add Tutor" OnClick="Registration_Click" ValidationGroup="signupbtn" />
		...
		<footer class="footer-distributed">
			...
			<div class="footer-left">
				...
				<p class="footer-links">
					...
					|
					<a href="UpdatePassword.aspx">ChangePassword</a>
				</p>
